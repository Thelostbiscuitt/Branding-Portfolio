const nextConfig = {
  images: {
    ...
    minimumCacheTTL: 60,
    // First-party SVG covers (e.g. the Relay case study's typographic cover)
    // are the only SVGs on the site and are authored in this repo.
        ...
        headers: [
          ...
          // Content Security Policy - allow necessary sources for portfolio
          {
            ...
            value: [
              ...
              // unsafe-inline for style-src covers next/font's injected <style>
              // tags and the standalone decks in /public (leadway-pitch,
              // ai-training-hub), which load their typefaces over the network.
