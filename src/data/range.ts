...
export const rangeNodes: RangeNode[] = [
  ...
  { id: 'n-image', kind: 'discipline', title: 'Image', meta: 'PRACTICE', parent: 'n-creative', description: 'Cover artwork, press photography and illustration as primary material.', related: ['p-blvckoreo', 'p-skaame', 'a-mainland', 'a-bc-covers'], confidence: 'verified' },
  ...
  { id: 'a-bedroom', kind: 'artifact', title: 'Bedroom Recordings', meta: 'RELEASE · AUDIOMACK', parent: 'p-blvckoreo', description: 'Raw bedroom recordings released on Audiomack — made and released as they were made.', related: ['n-music', 'n-artdirection'], sourceUrl: 'https://audiomack.com/', source: 'Audiomack', confidence: 'verified' },
