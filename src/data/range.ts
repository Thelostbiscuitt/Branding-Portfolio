...
export const rangeNodes: RangeNode[] = [
  /* ————— disciplines ————— */
  { id: 'n-design', kind: 'discipline', title: 'Design', meta: 'PRACTICE', description: 'Identity systems, cover art, editorial composition — where every project starts.', related: ['p-blvckoreo', 'p-skaame', 'p-layo'], confidence: 'verified' },
  { id: 'n-artdirection', kind: 'discipline', title: 'Art Direction', meta: 'PRACTICE', parent: 'n-design', description: 'Photographic worlds and type systems built per release — no templates.', related: ['p-blvckoreo', 'a-mainland', 'a-mars'], confidence: 'verified' },
  { id: 'n-image', kind: 'discipline', title: 'Image', meta: 'PRACTICE', parent: 'n-design', description: 'Cover artwork, press photography and illustration as primary material.', related: ['p-blvckoreo', 'p-skaame', 'a-mainland'], confidence: 'verified' },
  { id: 'n-video', kind: 'discipline', title: 'Video', meta: 'PRACTICE', parent: 'n-design', description: 'Promo film edited to the music it carries — cut to the beat, not to a template.', related: ['p-oneethfp', 'p-skaame', 'a-1ethfp-video'], confidence: 'verified' },
  { id: 'n-music', kind: 'discipline', title: 'Music', meta: 'PRACTICE', parent: 'n-design', description: 'Production, writing and release work — the first stage of the practice.', related: ['p-blvckoreo', 'p-oneethfp', 'p-skaame', 'p-layo'], confidence: 'verified' },
  { id: 'n-fashion', kind: 'discipline', title: 'Fashion / Merch', meta: 'PRACTICE', parent: 'n-design', description: 'The BO dice mark as a wearable identity — one mark, many surfaces.', related: ['a-bo-dice', 'p-blvckoreo'], confidence: 'contextual' },
  { id: 'n-culture', kind: 'discipline', title: 'Digital Culture', meta: 'PRACTICE', parent: 'n-design', description: 'Web3 music-and-culture work — community, roadmap, release rhythm.', related: ['p-oneethfp', 'a-1ethfp-roadmap'], confidence: 'verified' },
