...
export const rangeNodes: RangeNode[] = [
  ...
  { id: 'a-returndead', kind: 'artifact', title: 'Return of the Dead', meta: 'ARTWORK · BLVCK OREO', parent: 'p-blvckoreo', description: 'Cover artwork for Return of the Dead, the track streams from the same set the site plays.', related: ['n-image', 'n-music'], imageUrl: '/generated/rotd-artwork.webp', sourceUrl: '/Music/return-of-the-dead.mp3', source: 'LISTEN', confidence: 'verified' },
