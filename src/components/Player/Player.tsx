...
/**
 * Site-wide background music strip: a floating pill in the right gutter on
 * desktop/tablet, docking to a full-width bottom bar on phones (no caret, no
 * pop-up — every transport control stays visible). Pure static markup: the
 * single <audio>, play/pause/prev/next, shuffle, repeat-one, seek and the
 * first-interaction gate are all wired by public/engine.js. Track data rides
 * to the client as a JSON island — same pattern as the range dataset.
 */
