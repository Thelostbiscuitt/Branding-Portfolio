...
// .wrangler/tmp/pages-1YpIbe/functionsWorker-0.24197326027532995.mjs
...
__name2(readLimitedJson, "readLimitedJson");
function validEnquiry(body) {
  if (!body || typeof body !== "object" || Array.isArray(body)) return false;
  const { name, email, projectType, timeline, brief } = body;
  const textWithin = /* @__PURE__ */ __name2((value, max) => typeof value === "string" && value.length <= max, "textWithin");
...
__name2(validEnquiry, "validEnquiry");
...
__name2(notificationHtml, "notificationHtml");
...
__name2(acknowledgementHtml, "acknowledgementHtml");
...
__name2(audioResponse, "audioResponse");
...
// .wrangler/tmp/bundle-iMH3Lw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-iMH3Lw/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.24197326027532995.js.map
